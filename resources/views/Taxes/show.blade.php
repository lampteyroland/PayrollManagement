<x-app-layout>
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-900">Tax Amount:  {{$tax->tax_rate}}</label>
...
{{--            </div>--}}
            ...
            <div class="flex space-x-3 justify-end" x-data="{ showConfirmation: false }">
                ...
                <a href="/taxes/{{$tax->id}}/edit" class="bg-blue-500 text-white px-4 py-2 rounded">Edit</a>
            </div>
